...
class CountryTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        countryNameLabel.textColor = .none
        ...
        countryNameLabel.addConstraint(NSLayoutConstraint(item: countryNameLabel, attribute: .height, relatedBy: .greaterThanOrEqual, toItem: nil, attribute:.notAnAttribute, multiplier: 1.0, constant: 30))
