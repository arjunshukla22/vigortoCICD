...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var tagBackgroundColor: UIColor = UIColor.themeGreen {
        didSet {
            tagViews.forEach {
    ...
    @IBInspectable open dynamic var cornerRadiusTAG: CGFloat = 0 {
        didSet {
            tagViews.forEach {
    ...
    @IBInspectable open dynamic var borderWidthTAG: CGFloat = 0 {
        didSet {
            tagViews.forEach {
                $0.borderWidth = borderWidthTAG
            }
        }
    }
    
    @IBInspectable open dynamic var borderColorTAG: UIColor? {
        didSet {
            tagViews.forEach {
                $0.borderColor = borderColorTAG
            }
        }
    }
    ...
    @IBInspectable open dynamic var shadowColorTAG: UIColor = .white {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var shadowRadiusTAG: CGFloat = 0 {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var shadowOffsetTAG: CGSize = .zero {
        didSet {
            rearrangeViews()
        }
    }
    @IBInspectable open dynamic var shadowOpacityTAG: Float = 0 {
        didSet {
            rearrangeViews()
        }
    }
    ...
    @objc open dynamic var textFont: UIFont = .systemFont(ofSize: 14) {
        didSet {
            defer { rearrangeViews() }
            tagViews.forEach {
                $0.textFont = textFont
