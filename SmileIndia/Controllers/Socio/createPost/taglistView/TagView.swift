...
open class TagView: UIButton {
    ...
    @IBInspectable open var cornerRadiustag: CGFloat = 0 {
        didSet {
            layer.cornerRadius = cornerRadiustag
            layer.masksToBounds = cornerRadiustag > 0
        }
    }
    @IBInspectable open var borderWidthtag: CGFloat = 0 {
        didSet {
            layer.borderWidth = borderWidthtag
        }
    }
    
    @IBInspectable open var borderColortag: UIColor? {
        didSet {
            reloadStyles()
        }
    }
